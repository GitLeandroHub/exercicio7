...
pub mod pallet {
	...
	//Exercicio 7
	// Final Assignment => Storage : Difficulty - KittyDifficultyMultiplier: KittyIndex => u32
	#[pallet::storage]
...
impl<T: Config> Pallet<T> {
	...
	/// Final Assignment => - difficulty = multiplier * DefaultDifficulty
